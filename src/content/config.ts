...
const committee = defineCollection({
  ...
  schema: z.object({
    ...
    year: z.number(),
    group_photo: z.string().nullish().transform((value) => value ?? ''),
    description: z.string().nullish().transform((value) => value ?? ''),
    display_order: z.number().optional(),
    published: z.boolean().optional(),
    featured: z.boolean().optional(),
    updated_at: z.string().nullish().transform((value) => value ?? ''),
    status: z.enum(['current', 'archived']).nullish().transform((value) => value ?? undefined),
    chairman: z.string().nullish().transform((value) => value ?? ''),
    secretary: z.string().nullish().transform((value) => value ?? ''),
    members: z.array(
      z.object({ name: z.string(), role: z.string().nullish().transform((value) => value ?? ''), designation: z.string().nullish().transform((value) => value ?? ''), photo: z.string().nullish().transform((value) => value ?? ''), phone: z.string().nullish().transform((value) => value ?? ''), email: z.string().nullish().transform((value) => value ?? ''), address: z.string().nullish().transform((value) => value ?? ''), bio: z.string().nullish().transform((value) => value ?? ''), notes: z.string().nullish().transform((value) => value ?? ''), display_order: z.number().nullish().transform((value) => value ?? undefined) }),
    ),
  }),
});
...
const pages = defineCollection({
  ...
  schema: z.object({
    ...
    published: z.boolean().optional(),
    page_type: z.enum(['standard', 'landing', 'redirect']).optional(),
    display_order: z.number().optional(),
    updated_at: z.string().optional(),
    ...
    hero_overlay: z.enum(['dark', 'light', 'none']).optional(),
    cta_text: z.string().optional(),
    cta_url: z.string().optional(),
    gallery_enabled: z.boolean().optional(),
    gallery_albums: z.array(z.string()).optional(),
    documents_enabled: z.boolean().optional(),
    document_categories: z.array(z.string()).optional(),
    committee_enabled: z.boolean().optional(),
    committees: z.array(z.string()).optional(),
    quick_links_enabled: z.boolean().optional(),
    quick_links: z.array(z.object({ title: z.string(), url: z.string() })).optional(),
    downloads_enabled: z.boolean().optional(),
    downloads: z.array(z.object({ title: z.string(), document: z.string() })).optional(),
